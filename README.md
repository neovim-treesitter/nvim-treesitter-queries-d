# nvim-treesitter-queries-d

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-d/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-d/actions/workflows/validate.yml)

Neovim tree-sitter queries for **d**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-d",
...
- [ ] Changes are scoped to `d` — do not include files for other languages
